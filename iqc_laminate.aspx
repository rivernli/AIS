<%@ Page Language="C#" AutoEventWireup="true" Inherits="iqc_laminate" Codebehind="iqc_laminate.aspx.cs" %>
    ...
    <div>
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                ...
                <td>Copper Treatment<img src="images/icon_wand.gif" onclick="getAllValue('copperTreatment','coppertreatment')" style="cursor:pointer" /></td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="copperTreatment" runat="server" 
                        onkeyup="return getValue(this,'coppertreatment');" CssClass="txtbox_small" /></td>
