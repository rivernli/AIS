<%@ Page Language="C#" AutoEventWireup="true" Inherits="board" Codebehind="board.aspx.cs" %>
    ...
    <div>
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                <td>P/N</td>
                <td>Description</td>
                <td>Material Species<img src="images/icon_wand.gif" onclick="getAllValue('materialSpecies','mats')" style="cursor:pointer" /></td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox ID="materialSpecies" runat="server" 
                        onkeyup="return getValue(this,'mats');" CssClass="txtbox_small" /></td>
                <td>
                ...
                <td><asp:TextBox ID="thickness" runat="server" CssClass="txtbox_small" /></td>
            </tr>
            <tr valign="bottom">
                <td>Length</td>
                <td>Width</td>
            ...
            <tr valign="bottom">
                <td><asp:TextBox ID="length" runat="server" CssClass="txtbox_small" /></td>
                <td><asp:TextBox ID="width" runat="server" CssClass="txtbox_small" /></td>
                <td><asp:TextBox ID="signalCode" runat="server" Text="RDY" CssClass="txtbox_small"
                        /></td>
                <td><asp:TextBox ID="group" runat="server" CssClass="txtbox_small" /></td>
                <td>
