<%@ Page Language="C#" AutoEventWireup="true" Inherits="smd" Codebehind="smcm.aspx.cs" %>
    ...
    <div style="padding:0px 1px;">
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                ...
                <td><asp:TextBox ID="description" runat="server" onkeyup="return getValue(this,'dsca');"></asp:TextBox></td>
            ...
            <tr valign="bottom">
                ...
                <td><asp:TextBox ID="materialSpecies" runat="server" 
