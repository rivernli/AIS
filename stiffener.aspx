<%@ Page Language="C#" AutoEventWireup="true" Inherits="stiffener" Codebehind="stiffener.aspx.cs" %>
...
<body>
    ...
    <div style="padding:0px 1px;">
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                <td><asp:TextBox ID="part_number" runat="server" onkeyup="return getValue(this,'item');" CssClass="txtbox_small"></asp:TextBox></td>
                <td><asp:TextBox ID="description" runat="server" onkeyup="return getValue(this,'dsca');" CssClass="txtbox_small"></asp:TextBox></td>
                <td><asp:TextBox ID="vendor" runat="server" onkeyup="return getValue(this,'vdor');" CssClass="txtbox_small"></asp:TextBox>
                </td>
                <td><asp:TextBox ID="manufacturer" runat="server" onkeyup="return getValue(this,'mafr');" CssClass="txtbox_small"></asp:TextBox></td>
                <td><asp:TextBox ID="location" runat="server" onkeyup="return getValue(this,'loca');" CssClass="txtbox_small"/></td>
                <td><asp:TextBox ID="vendor_part_number" runat="server" onkeyup="return getValue(this,'vdpn');" CssClass="txtbox_small"/></td>
            ...
            <tr valign="bottom">
                ...
                <td>Dim Width</td>
                <td>Signal Code</td>
                <td>MAF#<img src="images/icon_wand.gif" onclick="getAllValue('maf','mafa')" style="cursor:pointer" CssClass="txtbox_small" /></td>
                <td colspan="2">
                    Plant</td>
            </tr>
            <tr valign="bottom">
                <td><asp:TextBox ID="adhThickness" runat="server" onkeyup="return getValue(this,'adth');" CssClass="txtbox_small"/></td>
                <td><asp:TextBox ID="dimLength" runat="server"  CssClass="txtbox_small"/></td>
                <td><asp:TextBox ID="dimWidth" runat="server"  CssClass="txtbox_small"/></td>
                <td><asp:TextBox ID="signalCode" runat="server" Text="RDY"  CssClass="txtbox_small"/></td>
                <td>
                <asp:TextBox ID="maf" runat="server" onkeyup="return getValue(this,'mafa');" CssClass="txtbox_small"/></td>
                <td colspan="2">
