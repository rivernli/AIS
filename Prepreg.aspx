<%@ Page Language="C#" AutoEventWireup="true" Inherits="Pregreg" Codebehind="Prepreg.aspx.cs" %>
    ...
    <div style="padding:0px 1px;">
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                ...
                <td>Type<img src="images/icon_wand.gif" onclick="getAllValue('type','atyp')" style="cursor:pointer" /></td>
            </tr>
            <tr>
                ...
                <td><asp:TextBox ID="location" runat="server" 
                        onkeyup="return getValue(this,'loca');" CssClass="txtbox_small"></asp:TextBox></td>
                <td><asp:TextBox ID="vendor_part_number" runat="server" 
                        onkeyup="return getValue(this,'vdpn');" CssClass="txtbox_small"/></td>
                <td><asp:TextBox ID="type" runat="server" onkeyup="return getValue(this,'atyp');" 
                        CssClass="txtbox_small" /></td>
            </tr>
            <tr>
                <td>RC (percent)<img src="images/icon_wand.gif" onclick="getAllValue('rc','rcpc')" style="cursor:pointer" /></td>
                <td>Laser Drillable</td>
                <td>Halogen Free</td>
                <td>Signal Code</td>
                <td>Dim Fill</td>
                <td>Dim Wrap</td>
            ...
            <tr>
                <td>
                <asp:TextBox ID="rc" runat="server" onkeyup="return getValue(this,'rcpc');" 
                        CssClass="txtbox_small" /></td>
                <td><asp:TextBox ID="laserDrillable" runat="server" CssClass="txtbox_small" /></td>
                <td><asp:TextBox ID="halogenFree" runat="server" CssClass="txtbox_small" /></td>
                <td><asp:TextBox ID="signalCode" runat="server" Text="RDY" 
                        CssClass="txtbox_small" /></td>
                <td><asp:TextBox ID="dimFill" runat="server" CssClass="txtbox_small" /></td>
                <td><asp:TextBox ID="dimWrap" runat="server" CssClass="txtbox_small" /></td>
                <td>
                <asp:TextBox ID="maf" runat="server" onkeyup="return getValue(this,'mafa');" 
                        CssClass="txtbox_small"/></td>
            </tr><tr>                
                <td colspan="7">
                    Plant:                     <asp:CheckBox ID="b1" runat="server" Text="B1" />
