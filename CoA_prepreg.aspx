<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CoA_prepreg.aspx.cs" Inherits="CoA_prepreg" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function __doViewPrepregCoA(dataId, Vers, T_UPRN, Vendor) {
            __newWin("CoA_prepreg_Form.aspx?Item=" + dataId + "&Vers=" + Vers + "&UPRN=" + T_UPRN + "&Vendor=" + Vendor, 1200, 700);
            return false;
        }
        ...
        <div style="padding: 0px 1px;">
            ...
            <div id="search_panel" style="display: block; background-color: #dedede;">
                <table cellspacing="1" cellpadding="1" border="0" class="stbTbl">
                    ...
                    <tr>
                        <td>
                            <asp:TextBox ID="part_number" runat="server" onkeyup="return getCoAValue(this,'IG005','#STDN!');" 
                                CssClass="txtbox_small"></asp:TextBox>
                        </td>
                        <td>
                            <asp:TextBox ID="txCoANo" runat="server" CssClass="txtbox_small" onkeyup="return getCoAValue(this,'IG005','#STSO!');"></asp:TextBox>
                        </td>
                        <td>
                        ...
                        <td>
                            <asp:TextBox ID="txLotNo" runat="server" CssClass="txtbox_small" onkeyup="return getCoAValue(this,'IG005','#STLT!');" />
                        </td>
                    </tr>
                </table>
            </div>
            ...
            <asp:GridView ID="GridView1" runat="server" Height="125px" Width="207px" AutoGenerateColumns="false"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="RCRequirementinIQCSpec" HeaderText="RC Requirement in IQC Spec" />
                    <asp:BoundField DataField="RCRequirementinCoA" HeaderText="RC Requirement in CoA" />
                    <asp:BoundField DataField="RF" HeaderText="RF" />
                    <asp:BoundField DataField="RFRequirementinIQCSpec" HeaderText="RF Requirement in IQC Spec" />
                    <asp:BoundField DataField="RFRequirementinCoA" HeaderText="RF Requirement in CoA" />
                    <asp:BoundField DataField="GT" HeaderText="Gel Time" />
                    <asp:BoundField DataField="GTRequirementinIQCSpec" HeaderText="Gel Time Requirement in IQC Spec" />
                    <asp:BoundField DataField="RFRequirementinCoA" HeaderText="Gel Time Requirement in CoA" />
                    <asp:BoundField DataField="VC" HeaderText="VC" />
                    <asp:BoundField DataField="MV" HeaderText="Minimum Viscosity" />
                    <asp:BoundField DataField="TV" HeaderText="Time of MV" />
                    <asp:BoundField DataField="FC" HeaderText=" Filler Content" />
