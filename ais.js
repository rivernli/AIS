    ...
    function getAllValue(o,fil)
    {
        ...
        filtering.getAllSelection(tbl,fil,setValue);
        return;
    }
    ...
    function getValue(o,fil)
    {
        ...
        selectionObject = o;
        if(o.value.trim() != "")
            filtering.getSelection(tbl,fil,o.value,setValue);
        return;
    }
    ...
    function getCoAAllValue(o, fil) {
        ...
        selectionObject = document.getElementById(o);
        filtering.getCoAAllSelection(tbl, fil, setValue);
        return;
    }

    function getCoAValue(o, type, fil) {
        if (tbl == "") {
            alert("No tbl provided");
            return;
        }
        ...
        selectionObject = o;
        if (o.value.trim() != "")
            filtering.getCoASelection(tbl, type, fil, o.value, setValue);
        return;
    }
