...
<body>
    ...
    <div style="padding:0px 1px;">
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                <td><asp:TextBox ID="vendor_part_number" runat="server" onkeyup="return getValue(this,'vdpn');" CssClass="txtbox_small"></asp:TextBox></td>
                <td><asp:TextBox ID="fluteLength" runat="server" CssClass="txtbox_small" /></td>
                <td><asp:TextBox ID="diameter" runat="server" onkeyup="return getValue(this,'diameter');"  CssClass="txtbox_small"/></td>
