<%@ Page Language="C#" AutoEventWireup="true" Inherits="databank_prepreg" Codebehind="databank_prepreg.aspx.cs" %>
    ...
    <div>
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                ...
                <td>RC(percent)<img src="images/icon_wand.gif" onclick="getAllValue('rc','rc')" style="cursor:pointer" /></td>
                <td>Type<img src="images/icon_wand.gif" onclick="getAllValue('type','type')" style="cursor:pointer" /></td>
                <td>Halogen Free</td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="rc" runat="server" CssClass="txtbox_small" onkeyup="return getValue(this,'rc');" ></asp:TextBox></td>
                <td><asp:TextBox ID="type" runat="server" 
                        onkeyup="return getValue(this,'type');" CssClass="txtbox_small"></asp:TextBox></td>
