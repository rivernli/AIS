<%@ Page Language="C#" AutoEventWireup="true" Inherits="coverLay" Codebehind="coverLay.aspx.cs" %>
    ...
    <div style="padding:0px 1px;">
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                ...
                <td>Film Thickness<img src="images/icon_wand.gif" onclick="getAllValue('filmThickness','fthi')" style="cursor:pointer" /></td>
            ...
            <tr>
                ...
                <td><asp:TextBox CssClass="txtbox_small" ID="vendor" runat="server" onkeyup="return getValue(this,'vdor');"></asp:TextBox>
                </td>
                <td>
                <asp:TextBox CssClass="txtbox_small" ID="manufacturer" runat="server" onkeyup="return getValue(this,'mafr');"></asp:TextBox></td>
                <td>
                <asp:TextBox CssClass="txtbox_small" ID="location" runat="server" onkeyup="return getValue(this,'loca');"></asp:TextBox></td>
                <td><asp:TextBox CssClass="txtbox_small" ID="filmThickness" runat="server" onkeyup="return getValue(this,'fthi');" /></td>
