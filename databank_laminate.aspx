<%@ Page Language="C#" AutoEventWireup="true" Inherits="databank_laminate" Codebehind="databank_laminate.aspx.cs" %>
    ...
    <div>
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                ...
                <td>Construction<img src="images/icon_wand.gif" onclick="getAllValue('Construction','Construction')" style="cursor:pointer" /></td>
                <td>Halogen Free</td>
            ...
            <tr>
                ...
                <td><asp:TextBox ID="Construction" runat="server" 
                        onkeyup="return getValue(this,'construction');" CssClass="txtbox_small"></asp:TextBox></td>
