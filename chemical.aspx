<%@ Page Language="C#" AutoEventWireup="true" Inherits="chemical" Codebehind="chemical.aspx.cs" %>
...
<body>
    ...
    <div style="padding:0px 1px;">
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                <td><asp:TextBox ID="hazardDesignation" runat="server" 
                        onkeyup="return getValue(this,'hade');" CssClass="txtbox_small" /></td>
