<%@ Page Language="C#" AutoEventWireup="true" Inherits="copperFoil" Codebehind="copperFoil.aspx.cs" %>
    ...
    <div style="padding:0px 1px;">
        ...
        <div id="search_panel" style="display:block; background-color:#dedede;">
            ...
            <tr>
                ...
                <td>Cu Thickness<img src="images/icon_wand.gif" onclick="getAllValue('cuThickness','oztk')" style="cursor:pointer" /></td>
                <td>Vendor P/N</td>
            </tr>
            <tr>
                ...
                <td>
                <asp:TextBox ID="cuThickness" runat="server" 
                        onkeyup="return getValue(this,'oztk');" CssClass="txtbox_small" /></td>
                <td>
                <asp:TextBox ID="vendorPN" runat="server" 
